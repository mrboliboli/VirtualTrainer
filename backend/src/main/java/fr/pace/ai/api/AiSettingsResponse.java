...
public record AiSettingsResponse(
        ...
        String statutDernierTest, Instant dateDernierTest, boolean generationSeanceApresImport
) {
    public static AiSettingsResponse from(AiConfiguration value, boolean keyConfigured) {
        return new AiSettingsResponse(value.isEnabled(), value.getActiveProvider(), value.getBaseUrl(),
                ...
                value.getLastTestStatus(), value.getLastTestedAt(), value.isAutoGenerateWorkoutAfterImport());
    }
}
